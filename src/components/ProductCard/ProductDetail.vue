...
<template>
    ...
    <div
        ...
        <img class="object-cover w-full rounded-t-lg h-100 md:h-auto md:w-[400px] md:rounded-none md:rounded-s-lg"
            :src="filterProduct[0]?.pro_image" alt="">
        <div class="flex flex-col justify-between p-4 leading-normal">
            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{{ filterProduct[0]?.pro_name }}</h5>
            <p class="mb-3 font-normal text-gray-700 dark:text-gray-900">{{ filterProduct[0]?.price }}</p>
            <div class="flex items-center mt-2.5 mb-5">
                ...
                <span
                    class="bg-blue-100 text-blue-800 text-xs font-semibold px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800 ms-3">{{ filterProduct[0]?.rating }}</span>
            </div>
